...
declare module com {
	export module onesignal {
		export class FocusDelaySyncJobService {
			public static class: java.lang.Class<com.onesignal.FocusDelaySyncJobService>;
...
declare module com {
	export module onesignal {
		export class FocusDelaySyncService {
			public static class: java.lang.Class<com.onesignal.FocusDelaySyncService>;
	...
	export module onesignal {
		...
		export module InAppMessageView {
			export class InAppMessageViewListener {
				 ...
				 */
				public constructor(implementation: { onMessageWasShown(): void; onMessageWasDismissed(): void });
				public constructor();
...
declare module com {
	export module onesignal {
		export class OSFocusDelaySync extends com.onesignal.OSBackgroundSync {
			public static class: java.lang.Class<com.onesignal.OSFocusDelaySync>;
			public scheduleSyncTask(param0: globalAndroid.content.Context): void;
			public getSyncServicePendingIntentClass(): java.lang.Class;
			public getSyncTaskId(): number;
			public getSyncTaskThreadId(): string;
...
declare module com {
	export module onesignal {
		export class OSInAppMessageController extends com.onesignal.OSBackgroundManager implements com.onesignal.OSDynamicTriggerController.OSDynamicTriggerControllerObserver, com.onesignal.OSSystemConditionController.OSSystemConditionObserver {
			...
			public constructor(param0: com.onesignal.OneSignalDbHelper, param1: com.onesignal.OSTaskController, param2: com.onesignal.OSLogger, param3: com.onesignal.language.LanguageContext);
			public initRedisplayData(param0: com.onesignal.OneSignalDbHelper): void;
			public messageTriggerConditionChanged(): void;
			public getInAppMessageDisplayQueue(): java.util.ArrayList<com.onesignal.OSInAppMessage>;
			public systemConditionChanged(): void;
			public constructor();
			public getRedisplayedInAppMessages(): java.util.List<com.onesignal.OSInAppMessage>;
			public messageDynamicTriggerCompleted(param0: string): void;
		}
	}
}
...
declare module com {
	export module onesignal {
		export class OSInAppMessageControllerFactory {
			...
			public getController(param0: com.onesignal.OneSignalDbHelper, param1: com.onesignal.OSTaskController, param2: com.onesignal.OSLogger, param3: com.onesignal.language.LanguageContext): com.onesignal.OSInAppMessageController;
		}
	}
}
...
declare module com {
	export module onesignal {
		export class OSInAppMessageDummyController extends com.onesignal.OSInAppMessageController {
			...
			public messageTriggerConditionChanged(): void;
			public systemConditionChanged(): void;
			public messageWasDismissed(param0: com.onesignal.OSInAppMessage): void;
			public messageDynamicTriggerCompleted(param0: string): void;
		}
	}
}
...
declare module com {
	export module onesignal {
		export class OSNotificationGenerationJob {
			...
			public setIamPreview(param0: boolean): void;
			public setRestoring(param0: boolean): void;
			public setOverriddenSound(param0: globalAndroid.net.Uri): void;
			public isIamPreview(): boolean;
...
declare module com {
	export module onesignal {
		export class OSTime {
			 ...
			 */
			public constructor(implementation: { getCurrentTimeMillis(): number; getElapsedRealtime(): number; getCurrentThreadTimeMillis(): number });
			public constructor();
			public getElapsedRealtime(): number;
			public getCurrentThreadTimeMillis(): number;
...
declare module com {
	export module onesignal {
		export class OneSignalAPIClient {
			 ...
			 */
			public constructor(implementation: {
				put(param0: string, param1: org.json.JSONObject, param2: com.onesignal.OneSignalApiResponseHandler): void;
				post(param0: string, param1: org.json.JSONObject, param2: com.onesignal.OneSignalApiResponseHandler): void;
				get(param0: string, param1: com.onesignal.OneSignalApiResponseHandler, param2: string): void;
				getSync(param0: string, param1: com.onesignal.OneSignalApiResponseHandler, param2: string): void;
				putSync(param0: string, param1: org.json.JSONObject, param2: com.onesignal.OneSignalApiResponseHandler): void;
				postSync(param0: string, param1: org.json.JSONObject, param2: com.onesignal.OneSignalApiResponseHandler): void;
			});
			public constructor();
...
declare module com {
	export module onesignal {
		export class WebViewManager extends com.onesignal.ActivityLifecycleHandler.ActivityAvailableListener {
			...
			public constructor(param0: com.onesignal.OSInAppMessage, param1: globalAndroid.app.Activity);
